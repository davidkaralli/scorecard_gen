...
len_grouped_scorecards_data = sum([len(grouped_scorecards_data[key]) for key in grouped_scorecards_data])
len_sorted_scorecards_data = sum([len(sorted_scorecards_data[key]) for key in sorted_scorecards_data])

#pprint.pprint(sorted_scorecards_data['3x3x3 Cube'])
pprint.pprint(sorted_scorecards_data)

print(len(scorecards_list))
print(len_grouped_scorecards_data)
print(len_sorted_scorecards_data)
assert(len(scorecards_list) == len_grouped_scorecards_data and len(scorecards_list) == len_sorted_scorecards_data)
